...
export default function PdfExtraction({ setPromptText }: ComponentTypes) {
  ...
  return (
    <div>
      <input
        className="mt-4 block w-full text-md text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
        type="file"
        accept=".pdf"
